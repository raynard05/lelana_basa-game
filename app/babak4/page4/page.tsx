...
export default function Babak4Page4() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const timerKeys = [
        'babak4_page4_timer_expiration',
        'babak4_page4_timer_paused_time',
      ];
  ...
  const handleTranscript = (text: string) => {
    ...
    const questionText = 'Ki Ageng Sapayana: "Yen kepengin meguru ing kene, apa awakmu wis siyap nampa sekabehe pacoban sing abot?"';
    const userAns = text;
  ...
  if (isValidating) {
    return (
      <div className="babak4-page4-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
  ...
  return (
    <div className="babak4-page4-container">
      {/* Top Left Home Button */}
      <Home className="babak4-page4-nav4-btn babak4-page4-home4-btn" />

      {/* Top Right Music Toggle Button */}
      <Music className="babak4-page4-nav4-btn babak4-page4-music4-btn" />
      ...
      <div className="babak4-page4-status-header">
        <GameStatusHeader
          babak={4}
          misi={2}
          score={score}
      ...
      <div className="babak4-page4-character-dialog-row">
        <div className="babak4-page4-character-portrait-container">
          <Image
            src="/babak4/page_4_assets/character1.webp"
            alt="Jaka Slewah"
            width={500}
            height={500}
            className="babak4-page4-character-portrait"
            priority
            unoptimized
          />
        </div>
      ...
      <div className="babak4-page4-character2-absolute-container">
        <Image
          src="/babak4/page_4_assets/character2.webp"
          alt="Lelana"
          width={500}
          height={500}
          className="babak4-page4-character2-portrait"
          priority
          unoptimized
        />
      </div>
      ...
      {transcriptFeedback && (
        <div className="babak4-page4-transcript-feedback">
      ...
      {showPopup && (
        <div className={`babak4-page4-popup-overlay ${showPopup === 'pop_streak' ? 'streak-popup-overlay' : ''}`} onClick={handleOverlayClick} style={{ cursor: 'pointer' }}>
          <div className={`babak4-page4-popup-card ${showPopup === 'pop_streak' ? 'streak-popup-card' : ''}`}>
            <Image
              src={
                showPopup === 'timeout'
              ...
              width={320}
              height={240}
              className="babak4-page4-popup-image"
              unoptimized
            />
          </div>
        </div>
