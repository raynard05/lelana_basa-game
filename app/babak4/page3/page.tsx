...
export default function Babak4Page3() {
  ...
  const handleProceed = () => {
    if (typeof window !== 'undefined') {
      localStorage.removeItem('babak4_page3_timer_expiration');
      localStorage.removeItem('babak4_page3_timer_paused_time');
    }
    router.push('/babak4/page4'); // Proceed to next chapter page
  };

  if (isValidating) {
    return (
      <div className="babak4-page3-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
  ...
  return (
    <div className="babak4-page3-container">
      {/* Top Left Home Button */}
      <Home className="babak4-page3-nav3-btn babak4-page3-home3-btn" />

      {/* Top Right Music Toggle Button */}
      <Music className="babak4-page3-nav3-btn babak4-page3-music3-btn" />
      ...
      <div className="babak4-page3-status-header">
        <GameStatusHeader
          babak={4}
          misi={1}
          score={score}
      ...
      <div className="babak4-page3-character-dialog-row">
        <div className="babak4-page3-character-portrait-container">
          <Image
            src="/babak4/page_3_assets/character.png"
            alt="Ki Ageng Sapayana"
            width={500}
            height={500}
            className="babak4-page3-character-portrait"
            priority
            unoptimized
          />
        </div>
      ...
      <div className="babak4-page3-options-wrapper">
        <UnggahUngguhOptions
          options={optionsData}
      ...
      {transcriptFeedback && (
        <div className="babak4-page3-transcript-feedback">
      ...
      {showPopup && (
        <div className={`babak4-page3-popup-overlay ${showPopup === 'pop_streak' ? 'streak-popup-overlay' : ''}`} onClick={handleOverlayClick} style={{ cursor: 'pointer' }}>
          <div className={`babak4-page3-popup-card ${showPopup === 'pop_streak' ? 'streak-popup-card' : ''}`}>
            <Image
              src={
                showPopup === 'timeout'
              ...
              width={320}
              height={240}
              className="babak4-page3-popup-image"
              unoptimized
            />
          </div>
        </div>
