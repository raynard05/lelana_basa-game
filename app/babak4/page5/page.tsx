...
export default function Babak4Page5() {
  ...
  const handleTranscript = (text: string) => {
    ...
    const targetWords = ['inggih', 'matur', 'nuwun', 'guru', 'kula', 'badhe', 'ndherek', 'panjenengan', 'nggih', 'njenengan', 'kulo'];
  ...
  const handleProceed = () => {
    if (typeof window !== 'undefined') {
      localStorage.removeItem('babak4_page5_timer_expiration');
      localStorage.removeItem('babak4_page5_timer_paused_time');
    }
    router.push('/babak5/page1');
  };

  if (isValidating) {
    return (
      <div className="babak4-page5-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
  ...
  return (
    <div className="babak4-page5-container">
      <Home className="babak4-page5-nav5-btn babak4-page5-home5-btn" />
      <Music className="babak4-page5-nav5-btn babak4-page5-music5-btn" />

      <Timer
        initialTime={6300}
        isLocked={isLocked || !!showPopup}
        onTimeOut={handleTimeOut}
        storageKey="babak4_page5_timer"
      />

      <div className="babak4-page5-status-header">
        <GameStatusHeader
          babak={4}
          misi={3}
          score={score}
      ...
      <div className="babak4-page5-character-dialog-row">
        <div className="babak4-page5-character-portrait-container">
          <Image
            src="/babak4/page_4_assets/character1.webp"
            alt="Ki Ageng Sapayana"
            width={500}
            height={500}
            className="babak4-page5-character-portrait"
            priority
            unoptimized
          />
        </div>
        <div className="babak4-page5-dialog-bubble-wrapper babak4-page5-dialog-bubble-wrapper-page5">
          <DialogBubble
            actorName="Ki Ageng Sapayana"
            dialogueText="Yen mangkono, saiki kowe resmi dadi muridku. Ayo melu aku mlebu padhepokan."
            speakerPosition="left"
            className="babak4-page5-dialog-bubble-container"
          />
        </div>
      </div>

      <div className="babak4-page5-character2-absolute-container">
        <Image
          src="/babak4/page_4_assets/character2.webp"
          alt="Lelana"
          width={500}
          height={500}
          className="babak4-page5-character2-portrait"
          priority
          unoptimized
        />
      </div>
      ...
      {transcriptFeedback && (
        <div className="babak4-page5-transcript-feedback">
          Swara sampeyan: "{transcriptFeedback}"
        </div>
      )}

      <div className="babak4-page5-bottom-actions-row">
        <ListenButton
      ...
      {showPopup && (
        <div className={`babak4-page5-popup-overlay ${showPopup === 'pop_streak' ? 'streak-popup-overlay' : ''}`} onClick={handleOverlayClick} style={{ cursor: 'pointer' }}>
          <div className={`babak4-page5-popup-card ${showPopup === 'pop_streak' ? 'streak-popup-card' : ''}`}>
            <Image
              src={
                showPopup === 'timeout'
              ...
              width={320}
              height={240}
              className="babak4-page5-popup-image"
              unoptimized
            />
          </div>
        </div>
