  ...
  return (
    <div className="babak9-page2-container">
      ...
      <div className="babak9-page2-card-frame">
        <AnimatedNarrationText babak={9} currentTime={currentTime} duration={duration} />
      </div>

      {/* Bottom Narration Audio Player Container */}
      <div className="babak9-page2-audio-container">
        <Sinopsis music_assets="/audio/babak9/page2.mp3"  onTimeUpdate={setCurrentTime} onDurationChange={setDuration} autoPlay={true} />
      </div>
    </div>
  );
}
