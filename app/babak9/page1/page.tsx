...
export default function Babak9Page1Page() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const timerKeys = [
        'babak9_timer_expiration',
        'babak9_timer_paused_time'
      ];
  ...
  return (
    <div className="babak9-page1-container">
      ...
      <div className="babak9-page1-card-frame" style={{ backgroundImage: "url('" + stepConfig.bgImage + "')" }}>
        <div className="babak9-page1-card-content-layout">

          <div className="babak9-page1-column-left">
            <Image
              src="/all_characters/character_babak9_page1.webp"
      ...
      <div className="babak9-page1-bottom-banner">
        <div className="babak9-page1-banner-content-layout">

        </div>
      </div>

      {showPopup && (
        <div className={"babak9-page1-popup-overlay " + (showPopup === 'pop_streak' ? 'streak-popup-overlay' : '')} onClick={handleOverlayClick} style={{ cursor: 'pointer' }}>
          <div className={"babak9-page1-popup-card " + (showPopup === 'pop_streak' ? 'streak-popup-card' : '')}>
            <Image
              src={
                showPopup === 'timeout'
