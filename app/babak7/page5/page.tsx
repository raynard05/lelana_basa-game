...
export default function babak7Page5() {
    ...
    const questionText = 'Prajurit: "Halah, rasah ngapusi! Wis ndang ngaliha, tinimbang taksuwunake paukuman!"';
    const userAns = text;
    ...
    return (
        <div className="babak7-page5-container">
            ...
            <div className="babak7-page5-bottom-actions-row">
                <ListenButton
                    audioUrl="/audio/babak7/8. prajurit 3.mp3"
                    disabled={isLocked}
                />
                <RecordButton
