...
export default function Babak7Page6Page() {
  ...
  return (
    <div className="babak7-page6-container">
      ...
      <div className="babak7-page6-card-frame" style={{ backgroundImage: "url('" + stepConfig.bgImage + "')" }}>
        <div className="babak7-page6-card-content-layout">

          <div className="babak7-page6-column-left">
            <Image
              src="/all_characters/character_babak7_page6.webp"
      ...
      <div className="babak7-page6-bottom-banner">
        <div className="babak7-page6-banner-content-layout">

        </div>
      </div>

      {showPopup && (
        <div className={"babak7-page6-popup-overlay " + (showPopup === 'pop_streak' ? 'streak-popup-overlay' : '')} onClick={handleOverlayClick} style={{ cursor: 'pointer' }}>
          <div className={"babak7-page6-popup-card " + (showPopup === 'pop_streak' ? 'streak-popup-card' : '')}>
            <Image
              src={
                showPopup === 'timeout'
