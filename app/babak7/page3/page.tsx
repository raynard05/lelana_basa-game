...
const optionsData: OptionData[] = [
    {
        id: 'A',
        text: "Sepurane. Tekaku iki ana urusan penting.",
        audioUrl: '/audio/babak7/3. ngoko lugu babak 7a.mp3',
    },
    {
        id: 'B',
        text: "Njaluk ngapura. Tekaku iki merga ana kabetahan wigati.",
        audioUrl: '/audio/babak7/4. ngoko alus babak 7a.mp3',
    },
    {
        id: 'C',
        text: "Nyuwun pangapunten. Sowanku amargi wonten kabetahan wigati.",
        audioUrl: '/audio/babak7/5. krama lugu babak 7a.mp3',
    },
    {
        id: 'D',
        text: "Nyuwun pangapunten. Sowan kula menika amergi wonten kabetahan Wigatos.",
        audioUrl: '/audio/babak7/6. krama alus babak 7a.mp3',
    },
];

export default function babak7Page3() {
    ...
    const questionText = 'Prajurit: "Mandheg! awakmu ora oleh mlebu regol kraton kene! Balia ae tinimbang dadi perkara!"';
    ...
    const handleProceed = () => {
        if (typeof window !== 'undefined') {
            localStorage.removeItem('babak7_page3_timer_expiration');
            localStorage.removeItem('babak7_page3_timer_paused_time');
        }
        router.push('/babak7/page4');
    };

    if (isValidating) {
        return (
            <div className="babak7-page3-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    ...
    return (
        <div className="babak7-page3-container">
            <Home className="babak7-page3-nav3-btn babak7-page3-home3-btn" />
            ...
            <div className="babak7-page3-status-header">
                <GameStatusHeader
                    babak={7}
                    misi={1}
                    score={score}
            ...
            <div className="babak7-page3-character-dialog-row">
                <div className="babak7-page3-character-portrait-container">
                    <Image
                        src="/babak7/page3.webp"
                        alt="Jaka Slewah"
                        width={500}
                        height={500}
                        className="babak7-page3-character-portrait"
                        priority
                        unoptimized
                    />
                </div>
                <div className="babak7-page3-dialog-bubble-wrapper">
                    <DialogBubble
                        actorName="Prajurit"
                        dialogueText="Mandheg! awakmu ora oleh mlebu regol kraton kene! Balia ae tinimbang dadi perkara!"
          ...
          isCorrect={isAnswerCorrect}
            ...
            {transcriptFeedback && (
                <div className="babak7-page3-transcript-feedback">
                    Swara sampeyan: "{transcriptFeedback}"
                </div>
            )}

            <div className="babak7-page3-bottom-actions-row">
                                <ListenButton
                    audioUrl="/audio/babak7/2. prajurit 1.mp3"
                    disabled={isLocked}
                />
<RecordButton
            ...
            {showPopup && (
                <div className={`babak7-page3-popup-overlay ${showPopup === 'pop_streak' ? 'streak-popup-overlay' : ''}`} onClick={handleOverlayClick} style={{ cursor: 'pointer' }}>
                    <div className={`babak7-page3-popup-card ${showPopup === 'pop_streak' ? 'streak-popup-card' : ''}`}>
                        <Image
                            src={
                                showPopup === 'timeout'
                            ...
                            width={320}
                            height={240}
                            className="babak7-page3-popup-image"
                            unoptimized
                        />
                    </div>
                </div>
