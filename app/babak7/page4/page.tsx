...
export default function babak7Page4() {
    ...
    const handleProceed = () => {
        if (typeof window !== 'undefined') {
            localStorage.removeItem('babak7_page4_timer_expiration');
            localStorage.removeItem('babak7_page4_timer_paused_time');
        }
    ...
    if (isValidating) {
        return (
            <div className="babak7-page4-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    ...
    return (
        <div className="babak7-page4-container">
            <Home className="babak7-page4-nav4-btn babak7-page4-home4-btn" />
            <Music className="babak7-page4-nav4-btn babak7-page4-music4-btn" />

            <Timer
                initialTime={60}
                isLocked={isLocked || !!showPopup}
                onTimeOut={handleTimeOut}
                storageKey="babak7_page4_timer"
            />

            <div className="babak7-page4-status-header">
                <GameStatusHeader
                    babak={7}
                    misi={2}
                    score={score}
            ...
            <div className="babak7-page4-character-dialog-row">
                <div className="babak7-page4-character-portrait-container">
                    <Image
                        src="/babak7/page4a.webp"
                        alt="Jaka Slewah"
                        width={500}
                        height={500}
                        className="babak7-page4-character-portrait"
                        priority
                        unoptimized
                    />
                </div>
            ...
            <div className="babak7-page4-character2-absolute-container">
                <Image
                    src="/babak7/page4b.webp"
                    alt="Lelana"
                    width={500}
                    height={500}
                    className="babak7-page4-character2-portrait"
                    priority
                    unoptimized
                />
            </div>
            ...
            {transcriptFeedback && (
                <div className="babak7-page4-transcript-feedback">
                    Swara sampeyan: "{transcriptFeedback}"
                </div>
            )}

            <div className="babak7-page4-bottom-actions-row">
                <ListenButton
                    audioUrl="/audio/babak7/7. prajurit 2.mp3"
                    disabled={isLocked}
                />
                <RecordButton
            ...
            {showPopup && (
                <div className={`babak7-page4-popup-overlay ${showPopup === 'pop_streak' ? 'streak-popup-overlay' : ''}`} onClick={handleOverlayClick} style={{ cursor: 'pointer' }}>
                    <div className={`babak7-page4-popup-card ${showPopup === 'pop_streak' ? 'streak-popup-card' : ''}`}>
                        <Image
                            src={
                                showPopup === 'timeout'
                            ...
                            width={320}
                            height={240}
                            className="babak7-page4-popup-image"
                            unoptimized
                        />
                    </div>
                </div>
