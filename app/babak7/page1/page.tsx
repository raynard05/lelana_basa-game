...
export default function Babak7Page1Page() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const timerKeys = [
        'babak7_timer_expiration',
        'babak7_timer_paused_time'
      ];
  ...
  const handleOptionClick = (optionId: string) => {
    ...
    const questionText = 'Analisis paraga Prajurit - ' + stepConfig.title;
  ...
  if (isValidating) {
    return (
      <div className="babak7-page1-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
  ...
  return (
    <div className="babak7-page1-container">
      <Home className="babak7-page1-nav-btn babak7-page1-home-btn" />
      ...
      <Music className="babak7-page1-nav-btn babak7-page1-music-btn" />
      
      <div className="babak7-page1-card-frame" style={{ backgroundImage: "url('" + stepConfig.bgImage + "')" }}>
        <div className="babak7-page1-card-content-layout">

          <div className="babak7-page1-column-left">
            <Image
              src="/all_characters/character_babak7_page1.webp"
              alt="Prajurit"
              width={100}
              height={100}
              className="babak7-page1-avatar-image-el"
              priority
              unoptimized
            />
          </div>

          <div className="babak7-page1-column-right">
           <div className="babak7-page1-options-container">
              {stepConfig.options.map((opt) => {
                const isSelected = selectedOption === opt.id;
                let btnClass = "babak7-page1-option-btn babak7-page1-opt-" + opt.id;

                if (isSelected) {
                  if (isAnswerCorrect) {
                    btnClass += " babak7-page1-correct-option";
                  } else if (isAnswerCorrect === false) {
                    btnClass += " babak7-page1-incorrect-option";
                  }
                }
      ...
      <div className="babak7-page1-bottom-banner">
        <div className="babak7-page1-banner-content-layout">

        </div>
      </div>

      {showPopup && (
        <div className={"babak7-page1-popup-overlay " + (showPopup === 'pop_streak' ? 'streak-popup-overlay' : '')} onClick={handleOverlayClick} style={{ cursor: 'pointer' }}>
          <div className={"babak7-page1-popup-card " + (showPopup === 'pop_streak' ? 'streak-popup-card' : '')}>
            <Image
              src={
                showPopup === 'timeout'
              ...
              width={320}
              height={240}
              className="babak7-page1-popup-image"
              unoptimized
            />
          </div>
        </div>
