...
const optionsData: OptionData[] = [
  {
    ...
    audioUrl: '/audio/babak5/3. ngoko lugu babak 5.mp3',
  },
  {
    id: 'B',
    text: 'Ampun mekaten. Aku mrene arep ngangsu kawruh, dudu pamer kasekten.',
    audioUrl: '/audio/babak5/4. ngoko alus babak 5.mp3',
  },
  {
    id: 'C',
    text: 'Ampun mekaten. Kula ing kene badhe ngangsu kawruh, sanes pamer kasekten.',
    audioUrl: '/audio/babak5/5. krama lugu babak 5.mp3',
  },
  {
    id: 'D',
    text: 'Ampun mekaten. Kula wonten mriki badhe ngangsu kawruh, sanes pamer kasekten.',
    audioUrl: '/audio/babak5/6. krama alus babak 5.mp3',
  },
];

export default function Babak5Page3() {
  ...
  const handleOptionSelect = (id: 'A' | 'B' | 'C' | 'D') => {
    ...
    const questionText = 'Surontanu: "He, Kebo Kicak! Aku ora trima yen awakmu dadi cantrik sing paling sekti!"';
  ...
  const handleProceed = () => {
    if (typeof window !== 'undefined') {
      localStorage.removeItem('babak5_page3_timer_expiration');
      localStorage.removeItem('babak5_page3_timer_paused_time');
    }
    router.push('/babak5/page4');
  };

  if (isValidating) {
    return (
      <div className="babak5-page3-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
  ...
  return (
    <div className="babak5-page3-container">
      <Home className="babak5-page3-nav3-btn babak5-page3-home3-btn" />
      <Music className="babak5-page3-nav3-btn babak5-page3-music3-btn" />

      <Timer
        initialTime={120}
        isLocked={isLocked || !!showPopup}
        onTimeOut={handleTimeOut}
        storageKey="babak5_page3_timer"
      />

      <div className="babak5-page3-status-header">
        <GameStatusHeader
          babak={5}
          misi={1}
          score={score}
      ...
      <div className="babak5-page3-character-dialog-row">
        <div className="babak5-page3-character-portrait-container">
          <Image
            src="/babak5/pages_3_assets/character_page3.webp"
            alt="Jaka Slewah"
            width={500}
            height={500}
            className="babak5-page3-character-portrait"
            priority
            unoptimized
          />
        </div>
      ...
      <div className="babak5-page3-options-wrapper">
        <UnggahUngguhOptions
          options={optionsData}
      ...
      {transcriptFeedback && (
        <div className="babak5-page3-transcript-feedback">
...
<RecordButton
      ...
      {showPopup && (
        <div className={`babak5-page3-popup-overlay ${showPopup === 'pop_streak' ? 'streak-popup-overlay' : ''}`} onClick={handleOverlayClick} style={{ cursor: 'pointer' }}>
          <div className={`babak5-page3-popup-card ${showPopup === 'pop_streak' ? 'streak-popup-card' : ''}`}>
            <Image
              src={
                showPopup === 'timeout'
              ...
              width={320}
              height={240}
              className="babak5-page3-popup-image"
              unoptimized
            />
          </div>
        </div>
